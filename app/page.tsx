...
import complaince from '@/public/compliance.png';
  ...
  return (
    <div className="h-full w-full bg-white flex items-center justify-center p-4">
      <div className="max-w-3xl w-full text-center">
        ...
        <Link href="/test">
          <button className="bg-[#0D25FF] hover:bg-[#0D25FF]/80 text-white font-semibold py-3 px-12 rounded-lg transition-colors duration-200">
            Start test
          </button>
        </Link>
      </div>
